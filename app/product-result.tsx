...
const getBadgeConfig = (colors: AppColors, isDark: boolean): Record<string, { 
    ...
    EU_BANNED: { icon: "close-circle", color: "#DC2626", bg: isDark ? "rgba(220,38,38,0.18)" : "#FEF2F2", labelKey: "results.badges.eu_banned" },
    FDA_WARN: { icon: "warning", color: "#D97706", bg: isDark ? "rgba(217,119,6,0.18)" : "#FFFBEB", labelKey: "results.badges.fda_warn" },
    HAZARDOUS_ADDITIVE: { icon: "skull", color: "#7C3AED", bg: isDark ? "rgba(124,58,237,0.18)" : "#F3E8FF", labelKey: "results.badges.fda_warn" },
    CONTAINS_ALLERGENS: { icon: "alert-circle", color: "#DC2626", bg: isDark ? "rgba(220,38,38,0.18)" : "#FEF2F2", labelKey: "results.badges.contains_allergens" },
    HIGH_SUGAR: { icon: "flame", color: "#DC2626", bg: isDark ? "rgba(220,38,38,0.18)" : "#FEF2F2", labelKey: "results.badges.high_sugar" },
    HIGH_SODIUM: { icon: "water", color: "#EA580C", bg: isDark ? "rgba(234,88,12,0.18)" : "#FFF7ED", labelKey: "results.badges.high_sodium" },
    HIGH_FAT: { icon: "fast-food", color: "#EA580C", bg: isDark ? "rgba(234,88,12,0.18)" : "#FFF7ED", labelKey: "results.badges.high_fat" },
    NO_ADDITIVES: { icon: "leaf", color: "#16A34A", bg: isDark ? "rgba(22,163,74,0.18)" : "#F0FDF4", labelKey: "results.badges.no_additives" },
    HIGH_PROTEIN: { icon: "barbell", color: "#2563EB", bg: isDark ? "rgba(37,99,235,0.18)" : "#EFF6FF", labelKey: "results.badges.high_protein" },
    SUGAR_FREE: { icon: "heart", color: "#0891B2", bg: isDark ? "rgba(8,145,178,0.18)" : "#ECFEFF", labelKey: "results.badges.sugar_free" },
    WHOLE_GRAIN: { icon: "nutrition", color: "#16A34A", bg: isDark ? "rgba(22,163,74,0.18)" : "#F0FDF4", labelKey: "results.badges.whole_grain" },
    HIGH_FIBER: { icon: "leaf", color: "#16A34A", bg: isDark ? "rgba(22,163,74,0.18)" : "#F0FDF4", labelKey: "results.badges.high_fiber" },
    LOW_FAT: { icon: "heart", color: "#0891B2", bg: isDark ? "rgba(8,145,178,0.18)" : "#ECFEFF", labelKey: "results.badges.low_fat" },
    LOW_SODIUM: { icon: "heart", color: "#0891B2", bg: isDark ? "rgba(8,145,178,0.18)" : "#ECFEFF", labelKey: "results.badges.low_sodium" },
    ORGANIC: { icon: "sparkles", color: "#16A34A", bg: isDark ? "rgba(22,163,74,0.18)" : "#F0FDF4", labelKey: "results.badges.organic" },
    VEGAN: { icon: "leaf", color: "#16A34A", bg: isDark ? "rgba(22,163,74,0.18)" : "#F0FDF4", labelKey: "results.badges.vegan" },
    VEGETARIAN: { icon: "nutrition", color: "#22C55E", bg: isDark ? "rgba(34,197,94,0.18)" : "#F0FDF4", labelKey: "results.badges.vegetarian" },
    GLUTEN_FREE: { icon: "checkmark-circle", color: "#0891B2", bg: isDark ? "rgba(8,145,178,0.18)" : "#ECFEFF", labelKey: "results.badges.gluten_free" },
