...
export const ADDITIVE_DATABASE: Record<string, AdditiveInfo> = {
    ...
    // === GENİŞLETME: sülfitler, emülgatörler, tat artırıcılar, fosfatlar, karameller, modifiye nişastalar ===
    ...
    E220: {
        ...
        risk: "CAUTION",
        reason: "A sulfite preservative used to prevent browning and microbial growth in dried fruit, wine and processed foods. Sulfites can trigger asthma attacks and allergic reactions in sensitive people, and EU law requires labeling above 10 mg/kg.",
        reasonTr: "Kurutulmuş meyve, şarap ve işlenmiş gıdalarda kararmayı ve mikrobik üremeyi önlemek için kullanılan bir sülfit koruyucudur. Sülfitler hassas kişilerde astım krizini ve alerjik reaksiyonları tetikleyebilir; AB 10 mg/kg üzerinde etikette belirtilmesini zorunlu kılar.",
        reasonEs: "Un conservante sulfito usado para evitar el pardeamiento y el crecimiento microbiano en frutas secas, vino y alimentos procesados. Los sulfitos pueden desencadenar ataques de asma y reacciones alérgicas en personas sensibles; la UE exige etiquetado por encima de 10 mg/kg.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "preservative",
        categoryTr: "Koruyucu",
    ...
    E221: {
        ...
        risk: "CAUTION",
        reason: "A sulfite preservative and antioxidant. Like other sulfites it can provoke asthma and allergic reactions in sensitive individuals and is a mandatory allergen label above 10 mg/kg in the EU.",
        reasonTr: "Bir sülfit koruyucu ve antioksidandır. Diğer sülfitler gibi hassas kişilerde astım ve alerjik reaksiyon tetikleyebilir; AB'de 10 mg/kg üzerinde zorunlu alerjen etiketidir.",
        reasonEs: "Un conservante y antioxidante sulfito. Como otros sulfitos, puede provocar asma y reacciones alérgicas en personas sensibles y es un alérgeno de etiquetado obligatorio por encima de 10 mg/kg en la UE.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "preservative",
        categoryTr: "Koruyucu",
    ...
    E222: {
        ...
        nameTr: "Sodyum Bisülfit",
        nameEs: "Bisulfito de Sodio",
        risk: "CAUTION",
        reason: "A sulfite preservative used in beverages and processed foods. Sulfites are a common trigger of asthma and allergic reactions; the EU mandates labeling above 10 mg/kg.",
        reasonTr: "İçecek ve işlenmiş gıdalarda kullanılan bir sülfit koruyucudur. Sülfitler astım ve alerjik reaksiyonların sık görülen bir tetikleyicisidir; AB 10 mg/kg üzerinde etiketlemeyi zorunlu kılar.",
        reasonEs: "Un conservante sulfito usado en bebidas y alimentos procesados. Los sulfitos son un desencadenante común de asma y reacciones alérgicas; la UE exige etiquetado por encima de 10 mg/kg.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "preservative",
        categoryTr: "Koruyucu",
    ...
    E223: {
        ...
        risk: "CAUTION",
        reason: "A widely used sulfite preservative and antioxidant in dried fruit, processed potato, wine and baked goods. It can trigger asthma and allergic reactions in sensitive people and may degrade thiamine (vitamin B1). The EU requires it to be declared as an allergen above 10 mg/kg.",
        reasonTr: "Kurutulmuş meyve, işlenmiş patates, şarap ve unlu mamullerde yaygın kullanılan bir sülfit koruyucu ve antioksidandır. Hassas kişilerde astım ve alerjik reaksiyon tetikleyebilir, tiamini (B1 vitamini) bozabilir. AB 10 mg/kg üzerinde alerjen olarak belirtilmesini zorunlu kılar.",
        reasonEs: "Un conservante y antioxidante sulfito muy usado en frutas secas, patata procesada, vino y productos horneados. Puede desencadenar asma y reacciones alérgicas en personas sensibles y degradar la tiamina (vitamina B1). La UE exige declararlo como alérgeno por encima de 10 mg/kg.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "preservative",
        categoryTr: "Koruyucu",
    ...
    E224: {
        ...
        risk: "CAUTION",
        reason: "A sulfite preservative common in winemaking and dried foods. As with all sulfites it can cause asthma and allergic reactions in sensitive people; EU labeling is mandatory above 10 mg/kg.",
        reasonTr: "Şarapçılık ve kuru gıdalarda yaygın bir sülfit koruyucudur. Tüm sülfitler gibi hassas kişilerde astım ve alerjik reaksiyona yol açabilir; AB'de 10 mg/kg üzerinde etiketleme zorunludur.",
        reasonEs: "Un conservante sulfito común en la vinificación y los alimentos secos. Como todos los sulfitos, puede causar asma y reacciones alérgicas en personas sensibles; el etiquetado en la UE es obligatorio por encima de 10 mg/kg.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "preservative",
        categoryTr: "Koruyucu",
    ...
    E226: {
        ...
        nameTr: "Kalsiyum Sülfit",
        nameEs: "Sulfito de Calcio",
        risk: "CAUTION",
        reason: "A sulfite preservative. Sulfites can trigger asthma and allergic reactions in sensitive individuals and must be labeled above 10 mg/kg in the EU.",
        reasonTr: "Bir sülfit koruyucudur. Sülfitler hassas kişilerde astım ve alerjik reaksiyon tetikleyebilir; AB'de 10 mg/kg üzerinde etikette belirtilmelidir.",
        reasonEs: "Un conservante sulfito. Los sulfitos pueden desencadenar asma y reacciones alérgicas en personas sensibles y deben etiquetarse por encima de 10 mg/kg en la UE.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "preservative",
        categoryTr: "Koruyucu",
    ...
    E227: {
        ...
        nameTr: "Kalsiyum Bisülfit",
        nameEs: "Bisulfito de Calcio",
        risk: "CAUTION",
        reason: "A sulfite preservative also used as a firming agent. Sulfites can provoke asthma and allergic reactions in sensitive people; EU labeling is required above 10 mg/kg.",
        reasonTr: "Sertleştirici olarak da kullanılan bir sülfit koruyucudur. Sülfitler hassas kişilerde astım ve alerjik reaksiyona yol açabilir; AB'de 10 mg/kg üzerinde etiketleme gerekir.",
        reasonEs: "Un conservante sulfito que también se usa como agente endurecedor. Los sulfitos pueden provocar asma y reacciones alérgicas en personas sensibles; en la UE se requiere etiquetado por encima de 10 mg/kg.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "preservative",
        categoryTr: "Koruyucu",
    ...
    E228: {
        ...
        nameTr: "Potasyum Bisülfit",
        nameEs: "Bisulfito de Potasio",
        risk: "CAUTION",
        reason: "A sulfite preservative used in wine and processed foods. Like other sulfites it can trigger asthma and allergic reactions; mandatory EU allergen labeling above 10 mg/kg.",
        reasonTr: "Şarap ve işlenmiş gıdalarda kullanılan bir sülfit koruyucudur. Diğer sülfitler gibi astım ve alerjik reaksiyon tetikleyebilir; AB'de 10 mg/kg üzerinde zorunlu alerjen etiketi.",
        reasonEs: "Un conservante sulfito usado en vino y alimentos procesados. Como otros sulfitos, puede desencadenar asma y reacciones alérgicas; etiquetado de alérgeno obligatorio en la UE por encima de 10 mg/kg.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "preservative",
        categoryTr: "Koruyucu",
    ...
    E200: {
        ...
        risk: "SAFE",
        reason: "A widely used preservative that inhibits mold and yeast. It is generally well tolerated and considered safe at normal food levels; rare skin irritation can occur in very sensitive people.",
        reasonTr: "Küf ve mayayı engelleyen yaygın bir koruyucudur. Normal gıda düzeylerinde genelde iyi tolere edilir ve güvenli kabul edilir; çok hassas kişilerde nadiren cilt tahrişi olabilir.",
        reasonEs: "Un conservante muy usado que inhibe el moho y la levadura. Generalmente se tolera bien y se considera seguro en niveles alimentarios normales; en personas muy sensibles puede ocurrir irritación cutánea rara.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "preservative",
        categoryTr: "Koruyucu",
    ...
    E202: {
        ...
        risk: "SAFE",
        reason: "One of the most common preservatives, used to stop mold and yeast in cheese, baked goods and drinks. It is considered low risk and generally safe; occasional mild skin or allergic sensitivity is reported.",
        reasonTr: "Peynir, unlu mamul ve içeceklerde küf ve mayayı durdurmak için kullanılan en yaygın koruyuculardan biridir. Düşük riskli ve genelde güvenli kabul edilir; nadiren hafif cilt veya alerjik hassasiyet bildirilmiştir.",
        reasonEs: "Uno de los conservantes más comunes, usado para detener el moho y la levadura en queso, productos horneados y bebidas. Se considera de bajo riesgo y generalmente seguro; ocasionalmente se reporta leve sensibilidad cutánea o alérgica.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "preservative",
        categoryTr: "Koruyucu",
    ...
    E203: {
        ...
        risk: "SAFE",
        reason: "A sorbate preservative against mold and yeast, similar to potassium sorbate. Considered low risk at normal levels.",
        reasonTr: "Potasyum sorbata benzer, küf ve mayaya karşı bir sorbat koruyucudur. Normal düzeylerde düşük riskli kabul edilir.",
        reasonEs: "Un conservante sorbato contra el moho y la levadura, similar al sorbato de potasio. Se considera de bajo riesgo en niveles normales.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "preservative",
        categoryTr: "Koruyucu",
    ...
    E471: {
        ...
        risk: "CAUTION",
        reason: "A very common emulsifier in bread, margarine, ice cream and ultra-processed foods. Generally regarded as safe, but it can be derived from animal or palm fat and may contain small amounts of trans fats; its presence is also a marker of ultra-processing.",
        reasonTr: "Ekmek, margarin, dondurma ve ultra-işlenmiş gıdalarda çok yaygın bir emülgatördür. Genelde güvenli kabul edilir; ancak hayvansal veya palm yağından elde edilebilir ve az miktarda trans yağ içerebilir; varlığı ultra-işlenmişlik göstergesidir.",
        reasonEs: "Un emulsionante muy común en pan, margarina, helado y alimentos ultraprocesados. Generalmente se considera seguro, pero puede derivarse de grasa animal o de palma y contener pequeñas cantidades de grasas trans; su presencia también indica ultraprocesamiento.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "emulsifier",
        categoryTr: "Emülgatör",
        categoryEs: "Emulsionante",
    },
    E472A: {
        code: "E472A",
        name: "Acetic Acid Esters of Mono- and Diglycerides",
        nameTr: "Mono- ve Digliseritlerin Asetik Asit Esterleri",
        nameEs: "Ésteres de Ácido Acético de Mono- y Diglicéridos",
        risk: "SAFE",
        reason: "An emulsifier used in baked goods and whipped toppings. Considered safe at normal use levels; a marker of processed foods.",
        reasonTr: "Unlu mamul ve krema kaplamalarında kullanılan bir emülgatördür. Normal kullanım düzeylerinde güvenli kabul edilir; işlenmiş gıda göstergesidir.",
        reasonEs: "Un emulsionante usado en productos horneados y coberturas batidas. Se considera seguro en niveles de uso normales; indicador de alimentos procesados.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "emulsifier",
        categoryTr: "Emülgatör",
    ...
    E472B: {
        ...
        nameTr: "Mono- ve Digliseritlerin Laktik Asit Esterleri",
        nameEs: "Ésteres de Ácido Láctico de Mono- y Diglicéridos",
        risk: "SAFE",
        reason: "An emulsifier common in whipped and aerated products. Considered safe at normal levels; indicates processed food.",
        reasonTr: "Krema ve havalandırılmış ürünlerde yaygın bir emülgatördür. Normal düzeylerde güvenli kabul edilir; işlenmiş gıda göstergesidir.",
        reasonEs: "Un emulsionante común en productos batidos y aireados. Se considera seguro en niveles normales; indica alimento procesado.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "emulsifier",
        categoryTr: "Emülgatör",
    ...
    E472C: {
        ...
        nameTr: "Mono- ve Digliseritlerin Sitrik Asit Esterleri",
        nameEs: "Ésteres de Ácido Cítrico de Mono- y Diglicéridos",
        risk: "SAFE",
        reason: "An emulsifier and antioxidant synergist used in margarine and sausages. Considered safe at normal use levels.",
        reasonTr: "Margarin ve sosislerde kullanılan bir emülgatör ve antioksidan sinerjistidir. Normal kullanım düzeylerinde güvenli kabul edilir.",
        reasonEs: "Un emulsionante y sinergista antioxidante usado en margarina y embutidos. Se considera seguro en niveles de uso normales.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "emulsifier",
        categoryTr: "Emülgatör",
    ...
    E472E: {
        code: "E472E",
        name: "DATEM (Diacetyltartaric Acid Esters)",
        nameTr: "DATEM (Diasetil Tartarik Asit Esterleri)",
        nameEs: "DATEM (Ésteres del Ácido Diacetiltartárico)",
        risk: "CAUTION",
        reason: "A dough-strengthening emulsifier widely used in industrial bread and bakery products. Generally considered safe for humans, though high doses caused heart effects in some animal studies; it is a strong marker of ultra-processed bakery foods.",
        reasonTr: "Endüstriyel ekmek ve fırın ürünlerinde yaygın kullanılan, hamuru güçlendiren bir emülgatördür. İnsanlar için genelde güvenli kabul edilir; ancak bazı hayvan çalışmalarında yüksek dozlarda kalp etkileri görülmüştür; ultra-işlenmiş fırın gıdalarının güçlü bir göstergesidir.",
        reasonEs: "Un emulsionante que refuerza la masa, muy usado en pan y bollería industrial. Generalmente se considera seguro para humanos, aunque dosis altas causaron efectos cardíacos en algunos estudios animales; es un fuerte indicador de bollería ultraprocesada.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "emulsifier",
        categoryTr: "Emülgatör",
    ...
    E475: {
        ...
        nameEs: "Ésteres de Poliglicerol de Ácidos Grasos",
        risk: "SAFE",
        reason: "An emulsifier used in cakes and chocolate. Considered safe at normal use levels; indicates processed food.",
        reasonTr: "Kek ve çikolatada kullanılan bir emülgatördür. Normal kullanım düzeylerinde güvenli kabul edilir; işlenmiş gıda göstergesidir.",
        reasonEs: "Un emulsionante usado en pasteles y chocolate. Se considera seguro en niveles de uso normales; indica alimento procesado.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "emulsifier",
        categoryTr: "Emülgatör",
    ...
    E476: {
        ...
        nameTr: "Poligliserol Polirisinoleat (PGPR)",
        nameEs: "Polirricinoleato de Poliglicerol (PGPR)",
        risk: "CAUTION",
        reason: "An emulsifier made from castor oil, used to reduce fat and improve flow in chocolate and spreads. Considered safe within limits, but it is a marker of cheaper, ultra-processed chocolate where it partly replaces cocoa butter.",
        reasonTr: "Hint yağından elde edilen, çikolata ve kremalarda yağı azaltmak ve akışkanlığı artırmak için kullanılan bir emülgatördür. Sınırlar içinde güvenli kabul edilir; ancak kakao yağının kısmen yerini aldığı daha ucuz, ultra-işlenmiş çikolatanın göstergesidir.",
        reasonEs: "Un emulsionante hecho de aceite de ricino, usado para reducir grasa y mejorar la fluidez en chocolate y cremas. Se considera seguro dentro de límites, pero es un indicador de chocolate más barato y ultraprocesado donde reemplaza parte de la manteca de cacao.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "emulsifier",
        categoryTr: "Emülgatör",
    ...
    E477: {
        ...
        nameTr: "Yağ Asitlerinin Propilen Glikol Esterleri",
        nameEs: "Ésteres de Propilenglicol de Ácidos Grasos",
        risk: "CAUTION",
        reason: "An emulsifier used in whipped toppings and cake mixes. Considered safe at permitted levels but is a marker of ultra-processed products.",
        reasonTr: "Krema kaplamaları ve kek karışımlarında kullanılan bir emülgatördür. İzin verilen düzeylerde güvenli kabul edilir; ancak ultra-işlenmiş ürün göstergesidir.",
        reasonEs: "Un emulsionante usado en coberturas batidas y mezclas para pasteles. Se considera seguro en niveles permitidos, pero es un indicador de productos ultraprocesados.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "emulsifier",
        categoryTr: "Emülgatör",
    ...
    E627: {
        ...
        risk: "CAUTION",
        reason: "A flavor enhancer almost always used together with MSG to boost savory taste in snacks and instant foods. It is broken down into purines, so people with gout or high uric acid should limit it; its presence usually signals a heavily seasoned ultra-processed food.",
        reasonTr: "Atıştırmalık ve hazır gıdalarda umami tadı artırmak için neredeyse her zaman MSG ile birlikte kullanılan bir tat artırıcıdır. Pürinlere parçalandığı için gut veya yüksek ürik asidi olanlar sınırlamalıdır; varlığı genellikle yoğun baharatlı ultra-işlenmiş gıdayı işaret eder.",
        reasonEs: "Un potenciador del sabor casi siempre usado junto con GMS para realzar el sabor salado en snacks y comidas instantáneas. Se descompone en purinas, por lo que las personas con gota o ácido úrico alto deben limitarlo; su presencia suele indicar un alimento ultraprocesado muy condimentado.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "flavor_enhancer",
        categoryTr: "Tat Artırıcı",
        categoryEs: "Potenciador del Sabor",
    },
    E631: {
        code: "E631",
        ...
        risk: "CAUTION",
        reason: "A flavor enhancer used with MSG in chips, instant noodles and seasonings. It produces purines, so people with gout should avoid it, and it is often derived from meat or fish (not vegetarian). It marks a heavily processed product.",
        reasonTr: "Cips, hazır erişte ve baharatlarda MSG ile kullanılan bir tat artırıcıdır. Pürin ürettiği için gut hastaları kaçınmalı; çoğunlukla et veya balıktan elde edilir (vejetaryen değil). Yoğun işlenmiş ürünü işaret eder.",
        reasonEs: "Un potenciador del sabor usado con GMS en patatas fritas, fideos instantáneos y condimentos. Produce purinas, por lo que las personas con gota deben evitarlo, y a menudo se deriva de carne o pescado (no vegetariano). Indica un producto muy procesado.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "flavor_enhancer",
        categoryTr: "Tat Artırıcı",
    ...
    E635: {
        ...
        nameTr: "Disodyum 5'-Ribonükleotidleri",
        nameEs: "Ribonucleótidos 5'-Disódicos",
        risk: "CAUTION",
        reason: "A blend of guanylate (E627) and inosinate (E631) used with MSG to intensify savory flavor. Same cautions apply: purine content (gout) and a marker of ultra-processed, heavily seasoned foods.",
        reasonTr: "Umami tadı yoğunlaştırmak için MSG ile kullanılan, guanilat (E627) ve inosinat (E631) karışımıdır. Aynı uyarılar geçerli: pürin içeriği (gut) ve ultra-işlenmiş, yoğun baharatlı gıda göstergesi.",
        reasonEs: "Una mezcla de guanilato (E627) e inosinato (E631) usada con GMS para intensificar el sabor salado. Aplican las mismas precauciones: contenido de purinas (gota) e indicador de alimentos ultraprocesados muy condimentados.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "flavor_enhancer",
        categoryTr: "Tat Artırıcı",
    ...
    E466: {
        ...
        nameTr: "Sodyum Karboksimetil Selüloz (CMC)",
        nameEs: "Carboximetilcelulosa de Sodio (CMC)",
        risk: "CAUTION",
        reason: "A thickener and stabilizer used in ice cream, sauces and diet foods. Approved as safe, but recent studies suggest emulsifiers like CMC may disturb the gut microbiome and intestinal lining with frequent intake.",
        reasonTr: "Dondurma, sos ve diyet gıdalarda kullanılan bir kıvam arttırıcı ve stabilizatördür. Güvenli onaylıdır; ancak son çalışmalar CMC gibi emülgatörlerin sık tüketimde bağırsak mikrobiyomunu ve bağırsak yüzeyini bozabileceğini öne sürmektedir.",
        reasonEs: "Un espesante y estabilizante usado en helado, salsas y alimentos dietéticos. Aprobado como seguro, pero estudios recientes sugieren que emulsionantes como la CMC pueden alterar la microbiota intestinal y el revestimiento intestinal con ingesta frecuente.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "thickener",
        categoryTr: "Kıvam Arttırıcı",
    ...
    E1422: {
        code: "E1422",
        name: "Acetylated Distarch Adipate (Modified Starch)",
        nameTr: "Asetillenmiş Distarch Adipat (Modifiye Nişasta)",
        nameEs: "Adipato de Dialmidón Acetilado (Almidón Modificado)",
        risk: "SAFE",
        reason: "A chemically modified starch used as a thickener and stabilizer in sauces, canned and frozen foods. Considered safe to digest, but it is a clear marker of ultra-processed food.",
        reasonTr: "Sos, konserve ve dondurulmuş gıdalarda kıvam arttırıcı ve stabilizatör olarak kullanılan kimyasal olarak modifiye edilmiş bir nişastadır. Sindirimi güvenli kabul edilir; ancak ultra-işlenmiş gıdanın belirgin bir göstergesidir.",
        reasonEs: "Un almidón modificado químicamente usado como espesante y estabilizante en salsas y alimentos enlatados y congelados. Se considera seguro de digerir, pero es un claro indicador de alimento ultraprocesado.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "thickener",
        categoryTr: "Kıvam Arttırıcı",
    ...
    E1442: {
        code: "E1442",
        name: "Hydroxypropyl Distarch Phosphate (Modified Starch)",
        nameTr: "Hidroksipropil Distarch Fosfat (Modifiye Nişasta)",
        nameEs: "Fosfato de Dialmidón Hidroxipropilado (Almidón Modificado)",
        risk: "SAFE",
        reason: "A modified starch thickener that resists heat and acidity, used in canned soups, sauces and dairy desserts. Considered safe to digest; a marker of ultra-processed food.",
        reasonTr: "Isıya ve aside dayanıklı, konserve çorba, sos ve sütlü tatlılarda kullanılan modifiye bir nişasta kıvam arttırıcıdır. Sindirimi güvenli kabul edilir; ultra-işlenmiş gıda göstergesidir.",
        reasonEs: "Un espesante de almidón modificado que resiste el calor y la acidez, usado en sopas enlatadas, salsas y postres lácteos. Se considera seguro de digerir; indicador de alimento ultraprocesado.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "thickener",
        categoryTr: "Kıvam Arttırıcı",
    ...
    E150A: {
        ...
        risk: "SAFE",
        reason: "Caramel color made by heating sugar without ammonia or sulfite compounds. The safest of the caramel colors, considered low risk.",
        reasonTr: "Amonyak veya sülfit bileşikleri olmadan şekerin ısıtılmasıyla yapılan karamel rengidir. Karamel renkleri içinde en güvenlisidir, düşük riskli kabul edilir.",
        reasonEs: "Color caramelo hecho calentando azúcar sin compuestos de amoníaco ni sulfito. El más seguro de los colores caramelo, considerado de bajo riesgo.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "colorant",
        categoryTr: "Renklendirici",
    ...
    E150B: {
        ...
        nameTr: "Kostik Sülfit Karamel",
        nameEs: "Caramelo de Sulfito Cáustico",
        risk: "CAUTION",
        reason: "Caramel color produced with sulfite compounds. Generally permitted, but it carries sulfite residues and is a marker of processed soft drinks and sauces.",
        reasonTr: "Sülfit bileşikleriyle üretilen karamel rengidir. Genelde izinlidir; ancak sülfit kalıntısı taşır ve işlenmiş gazlı içecek ve sosların göstergesidir.",
        reasonEs: "Color caramelo producido con compuestos de sulfito. Generalmente permitido, pero contiene residuos de sulfito y es un indicador de refrescos y salsas procesados.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "colorant",
        categoryTr: "Renklendirici",
    ...
    E338: {
        ...
        risk: "CAUTION",
        reason: "An acidity regulator that gives cola drinks their tang. High phosphate intake is linked to lower bone density and may stress the kidneys, especially when it crowds out calcium in the diet.",
        reasonTr: "Kola içeceklerine ekşiliğini veren bir asitlik düzenleyicidir. Yüksek fosfat alımı daha düşük kemik yoğunluğuyla ilişkilendirilir ve özellikle diyette kalsiyumun yerini aldığında böbrekleri zorlayabilir.",
        reasonEs: "Un regulador de acidez que da su acidez a las bebidas de cola. La ingesta alta de fosfato se relaciona con menor densidad ósea y puede sobrecargar los riñones, sobre todo cuando desplaza al calcio de la dieta.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "acidity_regulator",
        categoryTr: "Asitlik Düzenleyici",
    ...
    E339: {
        ...
        risk: "CAUTION",
        reason: "An acidity regulator and emulsifying salt in processed cheese and meats. Adds both sodium and phosphate; high phosphate intake may affect bone and kidney health over time.",
        reasonTr: "İşlenmiş peynir ve etlerde asitlik düzenleyici ve eritme tuzudur. Hem sodyum hem fosfat ekler; yüksek fosfat alımı zamanla kemik ve böbrek sağlığını etkileyebilir.",
        reasonEs: "Un regulador de acidez y sal emulsionante en queso y carnes procesados. Aporta tanto sodio como fosfato; la ingesta alta de fosfato puede afectar la salud ósea y renal con el tiempo.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "acidity_regulator",
        categoryTr: "Asitlik Düzenleyici",
    ...
    E340: {
        ...
        risk: "CAUTION",
        reason: "An acidity regulator and emulsifying salt used in processed foods. As with other phosphates, high cumulative intake may affect bone and kidney health.",
        reasonTr: "İşlenmiş gıdalarda kullanılan bir asitlik düzenleyici ve eritme tuzudur. Diğer fosfatlar gibi yüksek kümülatif alım kemik ve böbrek sağlığını etkileyebilir.",
        reasonEs: "Un regulador de acidez y sal emulsionante usado en alimentos procesados. Como otros fosfatos, la ingesta acumulada alta puede afectar la salud ósea y renal.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "acidity_regulator",
        categoryTr: "Asitlik Düzenleyici",
    ...
    E422: {
        ...
        nameTr: "Gliserol (Gliserin)",
        nameEs: "Glicerol (Glicerina)",
        risk: "SAFE",
        reason: "A humectant and sweetener that keeps foods moist, used in baked goods and bars. Considered safe; very high amounts can have a mild laxative effect.",
        reasonTr: "Gıdaları nemli tutan, unlu mamul ve barlarda kullanılan bir nem tutucu ve tatlandırıcıdır. Güvenli kabul edilir; çok yüksek miktarlar hafif müshil etkisi yapabilir.",
        reasonEs: "Un humectante y edulcorante que mantiene húmedos los alimentos, usado en productos horneados y barritas. Se considera seguro; cantidades muy altas pueden tener un leve efecto laxante.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "other",
        categoryTr: "Diğer",
    ...
    E551: {
        ...
        risk: "CAUTION",
        reason: "An anti-caking agent that keeps powders free-flowing in salt, spices and supplements. Considered safe to ingest, but the use of nano-sized particles has raised questions that food-safety agencies are still reviewing.",
        reasonTr: "Tuz, baharat ve takviyelerde tozların akışkan kalmasını sağlayan bir topaklanma önleyicidir. Yutulması güvenli kabul edilir; ancak nano boyutlu partikül kullanımı, gıda güvenliği kurumlarının hâlâ incelediği sorular doğurmuştur.",
        reasonEs: "Un antiaglomerante que mantiene fluidos los polvos en sal, especias y suplementos. Se considera seguro de ingerir, pero el uso de partículas de tamaño nanométrico ha planteado dudas que las agencias de seguridad alimentaria aún revisan.",
        euStatus: "ALLOWED",
        fdaStatus: "GRAS",
        category: "other",
        categoryTr: "Diğer",
